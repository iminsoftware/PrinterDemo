...
//        PrinterHelper.getInstance().labelPrintCanvas(1,null);
    ...
    public static Bitmap printLabelSize50x30_CN211(){
        PrinterHelper.getInstance().labelInitCanvas(LabelCanvasStyle.getCanvasStyle()
                .setWidth(50 * 8)
                .setHeight(30 * 8)
                .setPosX(48));
        PrinterHelper.getInstance().labelAddText("包装日期", LabelTextStyle.getTextStyle()
                .setPosX(30)
                .setPosY(30)
                .setTextSize(18));
        ...
        PrinterHelper.getInstance().labelAddText("2024.12.25", LabelTextStyle.getTextStyle()
                .setPosX(25)
                .setPosY(60)
                .setTextSize(18));
...
//        PrinterHelper.getInstance().labelPrintCanvas(1,null);
    ...
    public static Bitmap printLabelSize50x30EN211(){
        PrinterHelper.getInstance().labelInitCanvas(LabelCanvasStyle.getCanvasStyle()
                .setWidth(50 * 8)
                .setHeight(30 * 8)
                .setPosX(48));
        PrinterHelper.getInstance().labelAddText("PACKED ON", LabelTextStyle.getTextStyle()
                .setPosX(30)
                .setPosY(30)
                .setTextSize(18));
