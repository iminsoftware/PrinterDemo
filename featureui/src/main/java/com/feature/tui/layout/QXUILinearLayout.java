...
import com.feature.tui.alpha.QXUIAlphaLinearLayout;


public class QXUILinearLayout extends QXUIAlphaLinearLayout implements IQXUILayout {
    private QXUILayoutHelper mLayoutHelper;

    public QXUILinearLayout(Context context) {
        super(context);
        init(context, null, 0);
    }

    public QXUILinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public QXUILinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr);
    }

    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        mLayoutHelper = new QXUILayoutHelper(context, attrs, defStyleAttr, this);
    ...
    @Override
    public void setRadiusAndShadow(int radius, @QXUILayoutHelper.HideRadiusSide int hideRadiusSide, int shadowElevation, float shadowAlpha) {
    ...
    @Override
    public void setRadius(int radius, @QXUILayoutHelper.HideRadiusSide int hideRadiusSide) {
