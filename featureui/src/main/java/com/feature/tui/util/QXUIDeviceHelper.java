...
public class QXUIDeviceHelper {
    ...
    static {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O) {
            ...
            try {
                ...
                // QXUILog.printErrStackTrace(TAG, e, "read file error");
            } finally {
        ...
        try {
            ...
            // QXUILog.printErrStackTrace(TAG, e, "read SystemProperties error");
        }
    }

    public static boolean _isTablet(Context context) {
    ...
    public static boolean isPhone(String[] boards) {
