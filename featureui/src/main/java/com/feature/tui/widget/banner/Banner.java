package com.feature.tui.widget.banner;
...
import com.feature.tui.widget.banner.adapter.BannerAdapter;
import com.feature.tui.widget.banner.config.BannerConfig;
import com.feature.tui.widget.banner.config.IndicatorConfig;
import com.feature.tui.widget.banner.indicator.Indicator;
import com.feature.tui.widget.banner.listener.OnBannerListener;
import com.feature.tui.widget.banner.listener.OnPageChangeListener;
import com.feature.tui.widget.banner.transformer.MZScaleInTransformer;
import com.feature.tui.widget.banner.transformer.ScaleInTransformer;
import com.feature.tui.widget.banner.util.BannerLifecycleObserver;
import com.feature.tui.widget.banner.util.BannerLifecycleObserverAdapter;
import com.feature.tui.widget.banner.util.BannerUtils;
import com.feature.tui.widget.banner.util.LogUtils;
import com.feature.tui.widget.banner.util.ScrollSpeedManger;
...
public class Banner<T, BA extends BannerAdapter> extends FrameLayout implements BannerLifecycleObserver {
    ...
    private void initTypedArray(Context context, AttributeSet attrs) {
        ...
        normalColor = a.getColor(R.styleable.Banner_banner_indicator_normal_color, resources.getColor(R.color.xui_main_gray));
        selectedColor = a.getColor(R.styleable.Banner_banner_indicator_selected_color, resources.getColor(R.color.xui_config_color_main));
        indicatorGravity = a.getInt(R.styleable.Banner_banner_indicator_gravity, IndicatorConfig.Direction.RIGHT);
