...
import com.feature.tui.util.QXUIViewHelper;

import java.util.ArrayList;
import java.util.List;

import static com.feature.tui.widget.recyclerview.XUIRVItemSwipeAction.SWIPE_DOWN;
import static com.feature.tui.widget.recyclerview.XUIRVItemSwipeAction.SWIPE_LEFT;
import static com.feature.tui.widget.recyclerview.XUIRVItemSwipeAction.SWIPE_NONE;
import static com.feature.tui.widget.recyclerview.XUIRVItemSwipeAction.SWIPE_RIGHT;
import static com.feature.tui.widget.recyclerview.XUIRVItemSwipeAction.SWIPE_UP;

public class XUISwipeViewHolder extends RecyclerView.ViewHolder {
    ...
    public XUISwipeViewHolder(@NonNull View itemView) {
        super(itemView);
    }

    public void addSwipeAction(XUISwipeAction action) {
    ...
    void setup(int swipeDirection, boolean swipeDeleteIfOnlyOneAction) {
        ...
        for (ActionWrapper wrapper : mSwipeActions) {
            XUISwipeAction action = wrapper.action;
    ...
    XUISwipeAction checkUp(float x, float y, int touchSlop) {
    ...
    void draw(Canvas canvas, boolean overSwipeThreshold, float dx, float dy) {
        ...
        for (ActionWrapper actionInfo : mSwipeActions) {
            actionInfo.draw(canvas, overSwipeThreshold, mSetupDirection, alpha);
        }
    }
    ...
    static class ActionWrapper {
        ...
        public ActionWrapper(@NonNull XUISwipeAction action, @NonNull Callback callback) {
            this.action = action;
        ...
        void draw(Canvas canvas, boolean overSwipeThreshold, int direction, int alpha) {
            canvas.save();
            canvas.translate(left, top);
            action.paint.setStyle(Paint.Style.FILL);
            action.paint.setColor(action.mBackgroundColor);
            action.paint.setAlpha(alpha);
        ...
        private void startAnimator(float curLeft, float curTop, float targetLeft, float targetTop, int direction) {
            QXUIViewHelper.clearValueAnimator(animator);
            if (isVer(direction)) {
