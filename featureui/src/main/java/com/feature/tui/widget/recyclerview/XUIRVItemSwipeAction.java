...
public class XUIRVItemSwipeAction extends RecyclerView.ItemDecoration
    ...
    private static final String TAG = "QXUIRVItemSwipeAction";
        ...
        public boolean onInterceptTouchEvent(@NonNull RecyclerView recyclerView,
            ...
            if (action == MotionEvent.ACTION_DOWN) {
                ...
                if (mSelected == null) {
                    ...
                    if (mSelected instanceof XUISwipeViewHolder) {
                        XUISwipeViewHolder swipeViewHolder = (XUISwipeViewHolder) mSelected;
    ...
    public XUIRVItemSwipeAction(boolean swipeDeleteWhenOnlyOneAction, Callback callback) {
        mCallback = callback;
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        ...
        if (recyclerView != null) {
            ...
            mSwipeEscapeVelocity = resources.getDimension(R.dimen.qxui_rv_swipe_action_escape_velocity);
            mMaxSwipeVelocity = resources.getDimension(R.dimen.qxui_rv_swipe_action_escape_max_velocity);
            setupCallbacks();
        }
    }
    ...
    void handleSwipeActionActionUp(XUISwipeViewHolder swipeViewHolder, float x, float y, int touchSlop){
        XUISwipeAction action = swipeViewHolder.checkUp(x, y, touchSlop);
        if (action != null) {
    ...
    void select(@Nullable RecyclerView.ViewHolder selected, boolean isActionUp) {
        ...
        if (selected != null) {
            ...
            mSelected = selected;
            if (selected instanceof XUISwipeViewHolder) {
                XUISwipeViewHolder XUISwipeViewHolder = (XUISwipeViewHolder) selected;
                XUISwipeViewHolder.setup(mSwipeDirection, mSwipeDeleteWhenOnlyOneAction);
            }
        }
    ...
    private int checkSwipe(RecyclerView.ViewHolder viewHolder, int swipeDirection, boolean checkAction) {
        if (swipeDirection == SWIPE_LEFT || swipeDirection == SWIPE_RIGHT) {
            ...
            float threshold;
            if (checkAction && viewHolder instanceof XUISwipeViewHolder) {
                threshold = ((XUISwipeViewHolder) viewHolder).mActionTotalWidth;
            } else {
            ...
            float threshold;
            if (checkAction && viewHolder instanceof XUISwipeViewHolder) {
                threshold = ((XUISwipeViewHolder) viewHolder).mActionTotalHeight;
            } else {
    ...
    public static abstract class Callback {
        ...
        public void clearView(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
            ...
            if (viewHolder instanceof XUISwipeViewHolder) {
                ((XUISwipeViewHolder) viewHolder).clearTouchInfo();
            }
        }
        ...
        public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView,
            ...
            if (viewHolder instanceof XUISwipeViewHolder) {
                if (swipeDirection != SWIPE_NONE) {
                    ((XUISwipeViewHolder) viewHolder).draw(c, isOverThreshold(recyclerView, viewHolder, dX, dY, swipeDirection), dX, dY);
                }
            }
        }
    }
