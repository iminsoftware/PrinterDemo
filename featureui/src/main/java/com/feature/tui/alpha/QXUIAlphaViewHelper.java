...
public class QXUIAlphaViewHelper {
    ...
    public QXUIAlphaViewHelper(@NonNull View target) {
        mTarget = new WeakReference<>(target);
        mPressedAlpha = XUiResHelper.getAttrFloatValue(target.getContext(), R.attr.qxui_alpha_pressed);
        mDisabledAlpha = XUiResHelper.getAttrFloatValue(target.getContext(), R.attr.qxui_alpha_disabled);
    }

    public QXUIAlphaViewHelper(@NonNull View target, float pressedAlpha, float disabledAlpha) {
        mTarget = new WeakReference<>(target);
